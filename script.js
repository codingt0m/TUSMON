        ...
        function handleLogoClick() {
            // Si on est sur le menu, on compte les clics
        ...
        function initKeyboard() {
            ...
            backBtn.textContent = "⌫";
            backBtn.className = "keyboard-button wide";
            ...
            enterBtn.className = "keyboard-button wide";
        ...
        function updateHints() {
            // DÉCALAGE DES INDICES D'UN CRAN VERS LE HAUT (PLUS TÔT)

            // 1. Indice STADE (Dès le 2ème essai -> index 1)
            // Avant : currentRow >= 2
            if (currentRow >= 1) {
            ...
            // 2. Indice TYPE (Dès le 3ème essai -> index 2)
            // Avant : currentRow >= 3
            if (currentRow >= 2) {
            ...
            // 3. Indice GEN (Dès le 4ème essai -> index 3)
            if (gameMode === 'daily') {
                // Avant : currentRow >= 4
                if (currentRow >= 3) {
